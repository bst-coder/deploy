"""
HTTP-based cloud manager for ESP32 devices
Uses a simple HTTP API service for cloud communication
"""
...
class HTTPCloudManager:
    """Cloud device manager using HTTP API backend"""
    ...
    def __init__(self):
        ...
        # Use JSONBin.io as a simple cloud database (free tier)
        # You can replace this with any HTTP API service
        self.api_base = "https://api.jsonbin.io/v3/b"
        self.bin_id = "67a0f8e5e41b4d34e4749b8e"  # Pre-created bin for ESP32 data
        self.api_key = "$2a$10$8vQZxjKjGjKjGjKjGjKjGu"  # Example key (replace with real one)
    ...
    def start(self):
        ...
        if not self.running:
            ...
            print("🌐 HTTP Cloud Manager started")
    ...
    def load_from_cloud(self):
        ...
        try:
            ...
            if not self.use_memory_fallback:
                url = f"{self.api_base}/{self.bin_id}/latest"
            ...
            if not hasattr(self, '_initialized'):
                ...
                print("📡 Cloud storage initialized (in-memory)")
    ...
    def save_to_cloud(self):
        ...
        try:
            ...
            if not self.use_memory_fallback:
                ...
                url = f"{self.api_base}/{self.bin_id}"
    ...
    def get_connected_devices(self) -> Dict[str, Dict[str, Any]]:
        ...
        with self.lock:
            ...
            timeout = timedelta(minutes=2)  # Shorter timeout for better responsiveness
    ...
    def _cleanup_loop(self):
        ...
        while self.running:
            try:
                current_time = datetime.now()
                timeout = timedelta(minutes=2)  # 2 minutes timeout for cloud
                ...
                time.sleep(30)  # Check every 30 seconds for cloud
...
cloud_device_manager = HTTPCloudManager()